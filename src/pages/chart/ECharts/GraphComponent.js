...
const GraphComponent = () => {
  /* const getOtion = () => {
    const webkitDep = {
      type: 'force',
      categories: [
        { name: 'DataHolder', keyword: {}, base: 'DataHolder' },
        { name: 'DataCreator', keyword: {}, base: 'DataCreator' },
      ],
      nodes: [
        { name: gs1data[1].data.sender.id, value: 1, category: 1 },
        { name: gs1data[2].data.sender.id, value: 1, category: 1 },
      ],
      links: [
        { source: 0, target: 1 },
        { source: 0, target: 2 },
  ...
  // load gs1data list
  for (var i = 1; i <= 2; i++) {
    gs1data[i] = require('../json/WOT_Example_' + i + '.json')
    gs1data[i] = loadData(gs1data[i])
  }
  ...
  const graph = {
    nodes: [
      {
        id: 1,
        label: gs1data[1].data.sender.wallet,
        title: 'node 1 tootip text',
      },
      {
        id: 2,
        label: gs1data[2].data.sender.wallet,
